...
|----------------------------------|--------------------------------------|------------------------------|--------------------------------|---------------------------------------------|-------------------------------------------------|------------|
| Can be instantiated | Yes | Stable | No | Forbidden | Permitted | [fieldgroups/profile/profile-preferences-details.schema.json](fieldgroups/profile/profile-preferences-details.schema.json) |
## Schema Hierarchy

* Preference Details `https://ns.adobe.com/xdm/context/profile-preferences-details`
  * [Extensibility base schema](../../datatypes/extensible.schema.md) `https://ns.adobe.com/xdm/common/extensible`
  * [OptInOut](../../datatypes/deprecated/optinout.schema.md) `https://ns.adobe.com/xdm/context/optinout`
