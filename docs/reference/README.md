...
* [Identity Provider](./common/identityprovider.schema.md) – `https://ns.adobe.com/xdm/common/identityprovider`
...
* [Person Name](./context/personname.schema.md) – `https://ns.adobe.com/xdm/context/personname`
