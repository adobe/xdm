...
This class is used to capture minimum set of properties that define business opportunity. Note that this XDM class can only be included in the profile for customers with the B2B or B2P Edition.
