...
|----------|------------|-------------------|------------|
| Cannot be instantiated | Yes | Forbidden | [assets/language-alternative.schema.json](assets/language-alternative.schema.json) |
...
| Property | Type | Group |
|----------|------|-------|
| [xdm:text](#xdm:text) | `string` | `#/definitions/language-alternative` |
| [xml:lang](#xml:lang) | `string` | `#/definitions/language-alternative` |
