...
|----------------------------------|--------------------------------------|------------------------------|--------------------------------|---------------------------------------------|-------------------------------------------------|------------|
| Can be instantiated | Yes | Stable | No | Forbidden | Permitted | [fieldgroups/segment-definition/segmentdefinition-expression.schema.json](fieldgroups/segment-definition/segmentdefinition-expression.schema.json) |
## Schema Hierarchy
