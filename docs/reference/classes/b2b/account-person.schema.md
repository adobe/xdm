...
This class is used to capture XDM business account person relationship attributes. Note that this XDM class can only be included in the profile for customers with the B2B or B2P Edition.
