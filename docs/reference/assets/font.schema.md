...
|----------|------------|-------------------|------------|
| Can be instantiated | Yes | Forbidden | [assets/font.schema.json](assets/font.schema.json) |
...
|----------|------|----------|------------|
| [xdm:childFontFiles](#xdm:childFontFiles) | `string[]` | Optional | Font (this schema) |
| [xdm:composite](#xdm:composite) | `boolean` | Optional | Font (this schema) |
| [xdm:fontFace](#xdm:fontFace) | `string` | Optional | Font (this schema) |
| [xdm:fontFamily](#xdm:fontFamily) | `string` | Optional | Font (this schema) |
| [xdm:fontFileName](#xdm:fontFileName) | `string` | Optional | Font (this schema) |
| [xdm:fontName](#xdm:fontName) | `string` | **Required** | Font (this schema) |
| [xdm:fontType](#xdm:fontType) | `string` | **Required** | Font (this schema) |
| [xdm:versionString](#xdm:versionString) | `enum` | Optional | Font (this schema) |
