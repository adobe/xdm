...
* [Player state information](./context/player-state.schema.md) – `https://ns.adobe.com/xdm/context/player-state` (Experimental)
...
* [Episode](./external/iptc/episode.schema.md) – `http://www.iptc.org/episode` (Experimental)
