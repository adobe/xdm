...
# Generic Consent Field Schema

```
https://ns.adobe.com/xdm/datatype/consent-field
```

This schema specifies the fields in a basic consent object.

| [Abstract](../../../abstract.md) | [Extensible](../../../extensions.md) | [Status](../../../status.md) | [Identifiable](../../../id.md) | [Custom Properties](../../../extensions.md) | [Additional Properties](../../../extensions.md) | Defined In |
|----------------------------------|--------------------------------------|------------------------------|--------------------------------|---------------------------------------------|-------------------------------------------------|------------|
| Can be instantiated | Yes | Stable | No | Forbidden | Permitted | [datatypes/consent/consent-field.schema.json](datatypes/consent/consent-field.schema.json) |
## Schema Hierarchy

* Generic Consent Field `https://ns.adobe.com/xdm/datatype/consent-field`
...
# Generic Consent Field Properties
...
The value specified by the user as their consent choice or the basis of processing that precludes the need for user consent
