...
|----------|------------|-------------------|------------|
| Cannot be instantiated | Yes | Forbidden | [content/content.schema.json](content/content.schema.json) |
...
| [xdm:repositoryCreatedDate](#xdm:repositoryCreatedDate) | `string` | `#/definitions/content` |
| [xdm:repositoryCreatedBy](#xdm:repositoryCreatedBy) | `string` | `#/definitions/content` |
| [xdm:repositoryLastModifiedDate](#xdm:repositoryLastModifiedDate) | `string` | `#/definitions/content` |
| [xdm:repositoryLastModifiedBy](#xdm:repositoryLastModifiedBy) | `string` | `#/definitions/content` |
| [xdm:versionID](#xdm:versionID) | `string` | `#/definitions/content` |
